...
class SanPhamBoot extends Component {
   constructor(props){
        super(props)
        this.state = {
           products : [],
          ...
          <div className="mt-2" >
            <div class="col-md-3 float-left">
                <div class="hovereffect">
                    ...
                    <img class="img-responsive" src={this.props.product.image} alt=""/>
                        <div class="overlay">
                              <NavLink className="alert1" ><Alert/></NavLink>
